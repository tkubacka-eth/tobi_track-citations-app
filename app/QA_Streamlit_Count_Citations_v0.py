...
def generate_docs():
    ...
    st.write('The *References count* is set to *None*, since the API does not provide a direct reference count.')
    st.write('The *Authors count* is computed by taking the length of the authors list in the record.')
